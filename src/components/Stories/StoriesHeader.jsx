  ...
  return (
    <section className='stories-header'>
      <div className='stories-header__wrapper'>
        <div className='stories-header__content text-white p-20 relative min-h-[650px]'>
          ...
          <div className='stories-header__header'>
            ...
            <h1 className='text-[2.7rem] font-[700] mt-2 tracking-wider max-w-[300px]'>HAZY FULL MOON OF APPALACHIA</h1>
          ...
          <div className='stories-header__description mt-8'>
            <p className='max-w-[400px] text-white opacity-50'>The dissected plateau area, while not actually made up of geological mountains, is popularly called "mountains," especially in eastern Kentucky and West Virginia, and while the ridges are not high, the terrain is extremely rugged.</p>
