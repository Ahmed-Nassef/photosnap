...
const Header = ({contentStyle,headerStyle,paragraphStyle,sectionStyle,leftDivStyle,linkStyle,link,linkExist,isGradientShown,paragraph, header,section,imageUrl,BlackArrow}) => {
  return (
    <div className={`${section} ${sectionStyle} flex md:min-h-[650px] font-[700]`} id={section}>
      <div className={`section-${section}__left-div   ${leftDivStyle} w-full md:w-[60%] lg:w-[40%] flex flex-col relative items-center justify-center`}>
        <div style={{contentStyle}} className={`${section}__content  w-full relative px-4 py-8 md:py-0 md:pl-16 `}>
      ...
      <div className={`section-${section}__right-div w-full md:w-[40%] lg:w-[60%]`} >
