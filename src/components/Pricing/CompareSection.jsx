...
const CompareSection = () => {
  return (
    <section className='compare-section'>
      <div className='compare-section__wrapper p-[0.5rem] sm:p-16'>
        <div className='compare-section__content flex flex-col items-center'>
          ...
          <div className='compare-section__table font-[700] text-[12px] tracking-wider w-full sm:w-[600px] lg:w-[700px] uppercase'>
            ...
            <div className='grid row-2 my-4 grid-cols-5 p-4'>
              <span className='col-start-1 col-end-3 tracking-wider'>UNLIMITED STORY POSTING</span>
            ...
            <div className='grid row-3 my-4 grid-cols-5 p-4'>
              <span className='col-start-1 col-end-3 tracking-wider'>UNLIMITED PHOTO UPLOAD</span>
              <span className='center'><AiOutlineCheck fontSize={20} /></span>
              <span className='center'><AiOutlineCheck  fontSize={20}/></span>
              <span className='center'><AiOutlineCheck fontSize={20} /></span>
            </div>
            <div className='grid row-4 my-4 grid-cols-5 p-4'>
              <span className='col-start-1 col-end-3 tracking-wider'>EMBEDDING CUSTOM CONTENT</span>
              <span className='center'></span>
              <span className='center'><AiOutlineCheck fontSize={20} /></span>
              <span className='center'><AiOutlineCheck fontSize={20} /></span>
            </div>
            <div className='grid row-5 my-4 grid-cols-5 p-4'>
              <span className='col-start-1 col-end-3 tracking-wider'>CUSTOMIZE METADATA</span>
              <span></span>
              <span className='center'><AiOutlineCheck fontSize={20} /></span>
              <span className='center'><AiOutlineCheck fontSize={20} /></span>
            </div>
            <div className='grid row-6 my-4 grid-cols-5 p-4'>
              <span className='col-start-1 col-end-3 tracking-wider'>ADVANCED METRICS</span>
              <span></span>
              <span></span>
              <span className='center'><AiOutlineCheck  fontSize={20}/></span>
            </div>
            <div className='grid row-7 my-4 grid-cols-5 p-4'>
              <span className='col-start-1 col-end-3 tracking-wider'>PHOTO DOWNLOADS</span>
              <span></span>
              <span></span>
              <span className='center'><AiOutlineCheck fontSize={20} /></span>
            </div>
            <div className='grid row-8 my-4 grid-cols-5 p-4'>
              <span className='col-start-1 col-end-3 tracking-wider'>SEARCH ENGINE INDEXING</span>
              <span></span>
              <span></span>
              <span className='center'><AiOutlineCheck fontSize={20} /></span>
            </div>
            <div className='grid row-9 my-4 grid-cols-5 p-4'>
              <span className='col-start-1 col-end-3 tracking-wider'>CUSTOM ANALYTICS</span>
              <span></span>
              <span></span>
              <span className='center'><AiOutlineCheck fontSize={20} /></span>
            </div>
